(defpackage :grupo02pareja091RJ2604 ; se declara un paquete lisp que usa common-lisp
	(:use :common-lisp :mancala) ; y mancala, y exporta la función de evaluación
	(:export :heuristica :*alias*)) ; heurística y un alias para el torneo

(in-package grupo02pareja091RJ2604)

(defun heuristica (estado) 
    (f-eval-ponderation estado '((50 150 100 75 0 0) (175 125 25 0 0 0)))) ; función de evaluación heurística a implementar

(defvar *alias* '|aftereight|) ; alias que aparecerá en el ranking
