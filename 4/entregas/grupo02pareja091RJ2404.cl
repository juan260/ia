(defpackage :grupo02pareja091RJ2404 ; se declara un paquete lisp que usa common-lisp
	(:use :common-lisp :mancala) ; y mancala, y exporta la función de evaluación
	(:export :heuristica :*alias*)) ; heurística y un alias para el torneo

(in-package grupo02pareja091RJ2404)

(defun heuristica (estado) 
    (f-eval-ponderation estado '((0 0 75 125 100 175) (0 0 0 50 150 25)))) ; función de evaluación heurística a implementar
