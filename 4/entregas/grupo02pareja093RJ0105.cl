(defpackage :grupo02pareja093RJ0105 ; se declara un paquete lisp que usa common-lisp
	(:use :common-lisp :mancala) ; y mancala, y exporta la función de evaluación
	(:export :heuristica :*alias*)) ; heurística y un alias para el torneo

(in-package grupo02pareja093RJ0105)

(defun heuristica (estado) 
    (f-eval-ponderation estado '((90 30 120 120 240 180) (300 60 180 270 90 210)) '((150 270 30 90) (180 150 300 120)))) ; función de evaluación heurística a implementar

(defvar *alias* '|que_alegraba_siempre_el_corazon|) ; alias que aparecerá en el ranking
