(defpackage :grupo02pareja092RJ2604 ; se declara un paquete lisp que usa common-lisp
	(:use :common-lisp :mancala) ; y mancala, y exporta la función de evaluación
	(:export :heuristica :*alias*)) ; heurística y un alias para el torneo

(in-package grupo02pareja092RJ2604)

(defun heuristica (estado) 
    (f-eval-ponderation estado '((50 25 75 125 0 0)(200 150 175 100 0 0)))) ; función de evaluación heurística a implementar

(defvar *alias* '|vainilla|) ; alias que aparecerá en el ranking
