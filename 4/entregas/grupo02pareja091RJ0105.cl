(defpackage :grupo02pareja091RJ0105 ; se declara un paquete lisp que usa common-lisp
	(:use :common-lisp :mancala) ; y mancala, y exporta la función de evaluación
	(:export :heuristica :*alias*)) ; heurística y un alias para el torneo

(in-package grupo02pareja091RJ0105)

(defun heuristica (estado) 
    (f-eval-ponderation estado '((0 -68 -4 16 112 108) (52 96 24 -4 -60 -100)) '((-104 72 80 -8) (-80 76 -56 56)))) ; función de evaluación heurística a implementar

(defvar *alias* '|habia_una_vez|) ; alias que aparecerá en el ranking
