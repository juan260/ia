...
(defvar *peso* 90)
(defvar *ponderations* '((0 300 -90 270 -180 -240) (60 0 -210 -120 -30 210)))
(defvar *parameters* '((-30 -90 -150 -60) (-120 -300 60 120)))
...
(defvar *parameters2* '((1 -3 -49 111) (102 38 38 -90)))
(defvar *peso1* -34)
(defvar *peso2* -99)
...
(defvar *jdr-nmx-helado* (make-jugador
                        :nombre   '|tu-cree-que-yo-soi-guapa|
                        :f-juego  #'f-j-nmx
                        :f-eval   #'(lambda (x) (f-eval-ponderation x *ponderations* *parameters* *peso*))))
